...
var app = angular.module("App", ['toaster', 'ngAutocomplete', 'ngTouch', 'angucomplete-alt', 'ngDragDrop', 'ui.bootstrap']);
...
app.filter('startsWithLetter', function () {
    return function (items, letter) {
        ...
        for (var i = 0; i < items.length; i++) {
            ...
            if (letterMatch.test(String(item.FirstName).substring(0, 1))) {
                filtered.push(item);
